    ...
    <div className="bg-[#FEF5E6] py-16 px-6 md:px-14 lg:px-[204px]">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-[1320px] mx-auto justify-between items-start md:items-end mb-10 md:mb-12 gap-6">
        <div className="w-full md:max-w-[645px] space-y-2">
          <h2 className="text-2xl md:text-[40px] font-bold text-[#2D2C2F] font-ubuntu leading-[36px] md:leading-[48px] tracking-normal">
            The Travel Blog
          </h2>
      ...
      >
        {blogPosts.map((post) => (
          <div
            key={post.id}
            className="shrink-0 w-[85%] sm:w-[360px] md:w-[420px] h-auto p-4 bg-white rounded-[30px] shadow-sm snap-start"
          >
            <img
            ...
            <button className="mt-6 text-[#EC9105] text-[16px] sm:text-[20px] leading-[30px] font-normal font-ubuntu flex items-center gap-1">
              Read More
            </button>
          </div>
        ))}
      ...
      <div className="flex justify-center mt-10">
        <button className="px-6 sm:px-8 py-3 bg-[#EC9105] text-white font-semibold rounded-full shadow-lg transition duration-300 ease-in-out flex items-center space-x-2">
