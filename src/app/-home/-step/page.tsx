...
function Step() {
  return (
    <section className="w-full bg-white py-16 px-6 md:px-10 lg:px-24 ">
      <div className="max-w-[1320px] mx-auto  space-y-4 mb-10 mt-5">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 lg:gap-[40px]">
          {/* LEFT SECTION */}
          <div className="w-full lg:w-[645px] h-auto lg:h-[549px] flex flex-col justify-start gap-11">
            {/* Heading */}
        ...
        hidden xl:block"
            ...
            <div
              className="absolute 
                      top-[220px] sm:top-[270px] md:top-[290px] lg:top-[390px] 
